...
export function MobileHeader() {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/"
        className="z-50 relative w-10 h-10 flex items-center justify-center rounded-full overflow-hidden border border-white/10"
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-2">
                <a
                  href="https://github.com/AnasAfawzy"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/anasnaguib/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="flex items-center justify-center p-3 bg-primary/10 hover:bg-primary/15 text-primary rounded-xl border border-white/10 hover:border-primary/30 transition-all active:scale-95"
