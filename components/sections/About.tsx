  ...
  const skillCategories = [
    {
      ...
      icon: Layout,
      desc: "Building intuitive, responsive user interfaces",
    ...
    },
    {
      ...
      icon: Box,
      desc: "Streamlining development workflow",
      skills: skills.tools,
    },
    {
      title: "Computer Science",
      icon: Cpu,
      desc: "Foundational knowledge & Algorithms",
      skills: skills.cs,
    },
    {
    ...
    <div className="container mx-auto px-4 max-w-5xl space-y-32 mb-20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {aboutContent.highlights.map((item, idx) => {
          const icons = [Zap, Code2, Layout, Target];
